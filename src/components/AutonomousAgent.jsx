  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <h1 className="page-title">OrionSentinel Agent</h1>
          <p className="page-subtitle">
            Fully autonomous DeFi capital management on Base — liquidation protection, yield reallocation, and incentive qualification.
          </p>
        </div>
